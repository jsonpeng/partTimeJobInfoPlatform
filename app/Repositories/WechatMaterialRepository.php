...
class WechatMaterialRepository
{
    ...
    public function __construct(WechatMaterial $material)
    {
        $this->model = $material;
    }
     ...
     * @return Response
     */
    public function getList($type, $pageSize)
    {
    ...
    public function storeText($text)
    {
        ...
        $model->media_id = 'Media_TEXT_'.(WechatMaterial::count() + 1);
    ...
    public function storeArticle(
        ...
        $createdFrom = WechatMaterial::CREATED_FROM_WECHAT,
        $canEdited = WechatMaterial::CAN_EDITED
        ) {
        ...
        $canEdited)
    {
        $article['type'] = 'article';
        $article['can_edited'] = $canEdited;
        $article['created_from'] = WechatMaterial::CREATED_FROM_WECHAT;
        $article['account_id'] = $accountId;
    ...
    /**
     * 获取子素材
     * @param  [type] $parent_material_id [description]
     * @return [type]                     [description]
     */
    public function materialOfParent($parent_material_id)
    {
        return $this->model->where('parent_id', $parent_material_id)->get();
    }
